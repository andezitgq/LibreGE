/****************************************************************************
** Meta object code from reading C++ file 'filecheckthread.h'
**
...
#include <memory>
#include "../LibreGE/project/filecheckthread.h"
#include <QtCore/qbytearray.h>
#include <QtCore/qmetatype.h>
#if !defined(Q_MOC_OUTPUT_REVISION)
#error "The header file 'filecheckthread.h' doesn't include <QObject>."
...
QT_MOC_LITERAL(3, 29, 1) // "s"
    ...
    "FileCheckThread\0resultReady\0\0s"
};
...
void FileCheckThread::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<FileCheckThread *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        ...
        {
            using _t = void (FileCheckThread::*)(const QString & );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&FileCheckThread::resultReady)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void FileCheckThread::resultReady(const QString & _t1)
{
